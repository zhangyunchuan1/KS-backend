        ...
        <div class="question_box">
          <div class="question_header">
            <el-radio-group v-model="sectorSelection">
              ...
              v-for="menu in menuList" :key="menu.id" :label="menu"
              >{{menu.name}}</el-radio>
            </el-radio-group>
          </div>
              ...
              <div class="question_list" v-show="viewThirdLevel">
                <div class="question_list_box">
                  ...
                  <el-radio-group v-model="thirdLevel">
                    <el-radio @change="changeModel('threeMenu', threeMenu)"
                    v-for="threeMenu in threeMenuList" :key="threeMenu.id"
                     :label="threeMenu">{{threeMenu.name}}</el-radio>
                  </el-radio-group>
                </div>
              </div>
            </el-collapse-transition>
        ...
        <div class="question_table">
          ...
          <div class="question_header">
            ...
            <div class="question_search">
              <div>
                <el-input placeholder="视频题目搜索" v-model="searchObj.titleSearch" class="input-with-select">
                  <el-button @click="search" slot="append" icon="el-icon-search"></el-button>
                </el-input>
              </div>

              <div>
                <el-input placeholder="视频ID搜索" v-model="searchObj.idSearch" class="input-with-select">
                  <el-button @click="search" slot="append" icon="el-icon-search"></el-button>
                </el-input>
              </div>
            </div>
  ...
  export default {
    ...
    methods:{
      ...
      async remove() {
        ...
        let res = await this.HttpClient.post('/admin/menuRelationship/destroy', {menu_id: this.modifyObj.menu_id, relation_id: this.modifyObj.video_id});
      ...
      async changeModel(value, obj) {
        ...
        }else if(value === 'threeMenu') {
          this.getTableList({menu_id: obj.menu_id});
        }
        console.log('sectorSelection:', obj, this.sectorSelection);
      },
      async getTableList(param){
        ...
        // menu_id存在时，再判断
        console.log(params)
        if(param && param.menu_id) params.menu_id = param.menu_id;
        let res = await this.HttpClient.post('/admin/videos/getListByMajorMenuId', params);
