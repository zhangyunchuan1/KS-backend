                        ...
                        <el-table
                            ...
                            <el-table-column
                                    ...
                                    <template slot-scope="scope">
                                        ...
                                        <span v-if="scope.row.type === 3">回复</span>
                                        <span v-if="scope.row.type === 4">百科</span>
                                        <span v-if="scope.row.type === 5">视频</span>
                                        <span v-if="scope.row.type === 6">问题</span>
                                        <span v-if="scope.row.type === 7">淘货</span>
                                        <span v-if="scope.row.type === 8">酷圈</span>
                                        <span v-if="scope.row.type === 9">回答</span>
                                    </template>
                            </el-table-column>
                            ...
                            <el-table-column
                                    ...
                                    prop="like">
                                    <template slot-scope="scope">
                                        <span class="start_color" v-if="scope.row.like === 1">充电</span>
                                        <span class="sortout_color" v-if="scope.row.like === 0">漏电</span>
                                    </template>
                            </el-table-column>
