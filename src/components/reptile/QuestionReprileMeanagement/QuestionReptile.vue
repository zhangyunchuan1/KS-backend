                ...
                <div class="info_content">
                        <div class="info_content_left">
                                <div class="original_text_title">
                                        <div class="title_head">原问题标题</div>
                                        <el-input v-model="questionInfo" show-overflow-tooltip disabled></el-input>
                                </div>
                                ...
                                <div class="tags_box">
                                        ...
                                        <div class="tags">
                                                <el-tag v-for="tag in questionInfo" :key="tag" style="margin-right:5px;">{{tag}}</el-tag>
                                        </div>
                                </div>
                                <div class="old_content">原问题内容</div>
                        ...
                        <div class="info_content_right">
                                <div class="original_text_title">
                                        <div class="title_head">译问题标题</div>
                                ...
                                <div class="old_content">译问题内容</div>
                                <div class="content_old">
                                        <quill-editor
    ...
    export default {
        ...
        data(){
            return{
                ...
                tableData:[],
                modifyDialog:false,
                questionInfo:null,  //问题详情
                translationTitle:'',  //翻译后问题标题
                new_question:'',  //翻译后的问题
                newTags:[],  //标签
                inputValue:'',
                inputVisible:false,
                ...
                disableDialogList:[],  //驳回数组
                rejectReason:null,  //驳回理由
                disableDialogRadio:null,  //驳回选择ID
                disableDialog:false,
                deleteDialog:false,
                //分页
                total:null,
        ...
        methods:{
            ...
            //获取问题爬虫列表
            getSearchList(){
                this.HttpClient.post('/admin/ReptileQuestion/getList',{
                    pasSize:15,
