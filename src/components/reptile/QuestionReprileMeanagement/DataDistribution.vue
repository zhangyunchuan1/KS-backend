                    ...
                    <div class="content_table">
                        <el-table
                            ...
                            <el-table-column
                                ...
                                fixed="right">
                                <template slot-scope="scope">
                                    <el-button type="primary" plain size="mini">分配</el-button>
                                    <el-button type="primary" plain size="mini">重新分配</el-button>
                                    <el-button type="primary" plain size="mini">预览问题</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                        <el-pagination
