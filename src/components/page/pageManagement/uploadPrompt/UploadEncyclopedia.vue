<template>
  <div class="uploadEncyclopedia">
    <!--面包屑-->
    <BreadCrumb class="bread" :breadData="breadData"></BreadCrumb>
    <!--主体内容-->
    <div class="uploadEncyclopedia_main">
      <!--标题-->
      <div class="title">
        <p>上传百科</p>
      </div>
        ...
        breadData: [
          {
            ...
            id: 4,
            name: "上传百科",
            urls: "/index/page/pageManagement/uploadPrompt/UploadEncyclopedia",
            icon: "icon-home"
          }
        ],
...
<style lang="less">
  .uploadEncyclopedia{
    ...
    .uploadEncyclopedia_main::-webkit-scrollbar {
      display: none;
    }
    .uploadEncyclopedia_main {
      margin-left: 10px;
      margin-top: 10px;
      background: #fff;
