<template>
  <div class="backstageServiceShielding">
    <!--面包屑-->
    <BreadCrumb class="bread" :breadData="breadData"></BreadCrumb>
    <!--主体内容-->
    <div class="backstageServiceShielding_main">
      <!--标题-->
      <div class="title">
        <p>后台客服屏蔽</p>
      </div>
    ...
    return {
      ...
      breadData: [
        ...
        },
        {
          ...
          name: "后台客服屏蔽",
          urls:
            "/index/page/pageManagement/auditManagement/backstageServiceShielding",
          icon: "icon-home"
        }
      ],
      valindex: null,
...
<style lang="less">
  .backstageServiceShielding{
    ...
    .backstageServiceShielding_main::-webkit-scrollbar {
      display: none;
    }
