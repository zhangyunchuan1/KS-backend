<template>
  <div class="commentAuditManagement">
    <!--面包屑-->
    <BreadCrumb class="bread" :breadData="breadData"></BreadCrumb>
    <!--主体内容-->
    <div class="commentAuditManagement_main">
      <!--标题-->
      <div class="title">
        <p>评论审核管理</p>
      </div>
    ...
    return {
      ...
      breadData: [
        ...
        },
        {
          ...
          name: "评论审核管理",
          urls:
            "/index/page/pageManagement/auditManagement/CommentAuditManagement",
          icon: "icon-home"
        }
      ],
      valindex: null,
...
<style lang="less">
.commentAuditManagement {
  text-align: left;
  .bread {
    margin: 10px;
  }
  .commentAuditManagement_main::-webkit-scrollbar {
    display: none;
  }
  .commentAuditManagement_main {
    margin-left: 10px;
    margin-top: 10px;
    background: #fff;
