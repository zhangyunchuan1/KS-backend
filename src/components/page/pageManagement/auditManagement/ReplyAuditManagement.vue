<template>
  <div class="replyAuditManagement">
    <!--面包屑-->
    <BreadCrumb class="bread" :breadData="breadData"></BreadCrumb>
    <!--主体内容-->
    <div class="replyAuditManagement_main">
      <!--标题-->
      <div class="title">
        <p>回复审核管理</p>
      </div>
    ...
    return {
      ...
      breadData: [
        ...
        },
        {
          ...
          name: "回复审核管理",
          urls:
            "/index/page/pageManagement/auditManagement/replyAuditManagement",
          icon: "icon-home"
        }
      ],
      valindex: null,
...
<style lang="less">
.replyAuditManagement {
  text-align: left;
  .bread {
    margin: 10px;
  }
  .replyAuditManagement_main::-webkit-scrollbar {
    display: none;
  }
  .replyAuditManagement_main {
    margin-left: 10px;
    margin-top: 10px;
    background: #fff;
