    ...
    <div class="userComment">
                    ...
                    <div class="table">
                        <el-table
                            ...
                            <el-table-column
                                    ...
                                    prop="status">
                                    <template slot-scope="scope">
                                        <span :style="scope.row.status===1?'color:#1E90FF;':'color:#A52A2A;'">{{scope.row.status===1?'正常':'未通过'}}</span>
                                    </template>
                            </el-table-column>
        ...
        <el-dialog
            ...
            <div class="evaluationDialog_box">
                ...
                <div class="annex_box">
                    <img @click="previewImg(item.path)" v-for="(item,index) in commentInfo.attachment" :key="index" :src="Tools.handleImg(item.path)" alt="">
                </div>
            </div>
...
<script>
    ...
    export default {
                ...
                breadData: [
                    {
                        ...
                        id: 3,
                        name: '用户评论',
                        urls: '/index/market/marketSales/UserComment',
                        icon: 'icon-home'
                    }
                ],
        ...
        methods:{
            ...
            //获取评论频率
            getCommentFrequency(){
                this.HttpClient.post('/admin/answers/rate',{type:1})
                    .then(res=>{
                        console.log(res);
